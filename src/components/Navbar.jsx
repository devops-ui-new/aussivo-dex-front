              ...
              <div className="relative">
                ...
                {menuOpen && (
                  <div className="absolute right-0 mt-2 w-60 glass p-2 shadow-2xl" style={{ animation: "modalIn 0.15s ease-out" }}>
                    ...
                    <Link to="/swap" className="flex items-center gap-2.5 px-3 py-2 text-sm text-slate-300 hover:bg-surface-3 rounded-lg" onClick={() => setMenuOpen(false)}>🔄 Swap & Buy</Link>
